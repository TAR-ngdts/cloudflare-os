/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: de2cdcc367d10c20026b17f65c71c886)
// Runtime types generated with workerd@1.20260831.1 2026-09-04 allow_irrevocable_stub_storage
interface __BaseEnv_Env {
	GATEWAY_URL: "https://ngdots.example.com";
	BASE_URL: "http://localhost:8787/gatekeeper/ng-dots";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/ng-dots");
		durableNamespaces: "NgDotsUserAccount" | "NgDotsGatekeeper";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_URL" | "BASE_URL">> {}
}
declare module "*.txt" {
	const value: string;
